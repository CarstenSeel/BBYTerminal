...
@Component({
  ...
  templateUrl: './deleteSizeDialog.component.html',
  styleUrls: ['./deleteSizeDialog.component.scss']
})
export class DeleteSizeDialogComponent implements OnInit {
    ...
    constructor (
        public dialogRef: MatDialogRef<DeleteSizeDialogComponent>,
